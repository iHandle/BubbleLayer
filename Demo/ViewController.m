...
- (void)viewDidLoad {
    ...
    bubbleLayer = [[BubbleLayer alloc]initWithLayerFrame:myView1.bounds];
    ...
    bubbleLayer = [[BubbleLayer alloc]initWithLayerFrame:myView2.bounds];
    ...
    bubbleLayer = [[BubbleLayer alloc]initWithLayerFrame:myView3.bounds];
